...
function Header({ title }: { title: string }) {
  ...
  return (
    <div className="sticky top-0 w-full md:z-0 z-20">
      <div
      ...
      >
        <div className="md:text-2xl ml-8 text-base flex flex-col md:flex-row justify-center md:justify-start min-w-fit">
          {title}
        </div>
        <img
          src="../../Logo.svg"
